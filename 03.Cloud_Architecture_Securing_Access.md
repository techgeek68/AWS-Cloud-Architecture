...
**8. Real-World Application - cafe Scenario**

**Security Considerations**

* Prakash & Maya: Non-technical owners → Minimal access
* Sushma: Technical manager → Administrative access
...
IAM Structure:
  Admin Group:
    - Sushma (Full administrative access with MFA)
  ...
  Root User:
    - Prakash & Maya(Emergency access only)
```
